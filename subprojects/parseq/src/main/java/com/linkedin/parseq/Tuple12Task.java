...
public interface Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> extends Task<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> {
  ...
  default <R> Task<R> flatMap(final String desc,
      final Function12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Task<R>> f) {
   ...
   */
  default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> andThen(
      final Consumer12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> consumer) {
   ...
   */
  default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> andThen(final String desc,
      final Consumer12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> consumer) {
   ...
   */
  @Override
  default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> recover(
      final Function1<Throwable, Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> f) {
   ...
   */
  @Override
  default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> recover(final String desc,
      final Function1<Throwable, Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> f) {
   ...
   */
  @Override
  default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> recoverWith(
      final Function1<Throwable, Task<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>> f) {
   ...
   */
  @Override
  default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> recoverWith(final String desc,
      final Function1<Throwable, Task<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>> f) {
   ...
   */
  @Override
  public default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> onFailure(
   ...
   */
  @Override
  public default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> onFailure(final String desc,
      final Consumer1<Throwable> consumer) {
   ...
   */
  @Override
  public default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> withTimeout(final long time,
      final TimeUnit unit) {
   ...
   */
  default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> withSideEffect(
      Function12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Task<?>> func) {
   ...
   * completion of this task
   */
  default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> withSideEffect(final String desc,
      Function12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Task<?>> func) {
  ...
  public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> cast(
      final Task<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> task) {
