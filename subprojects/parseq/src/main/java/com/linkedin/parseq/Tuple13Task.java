...
public interface Tuple13Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> extends Task<Tuple13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>> {
  ...
  default <R> Task<R> flatMap(final String desc,
      final Function13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, Task<R>> f) {
   ...
   */
  default Tuple13Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> andThen(
      final Consumer13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> consumer) {
   ...
   */
  default Tuple13Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> andThen(final String desc,
      final Consumer13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> consumer) {
   ...
   */
  @Override
  default Tuple13Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> recover(
      final Function1<Throwable, Tuple13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>> f) {
   ...
   */
  @Override
  default Tuple13Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> recover(final String desc,
      final Function1<Throwable, Tuple13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>> f) {
   ...
   */
  @Override
  default Tuple13Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> recoverWith(
      final Function1<Throwable, Task<Tuple13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>>> f) {
   ...
   */
  @Override
  default Tuple13Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> recoverWith(final String desc,
      final Function1<Throwable, Task<Tuple13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>>> f) {
   ...
   */
  @Override
  public default Tuple13Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> onFailure(
   ...
   */
  @Override
  public default Tuple13Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> onFailure(final String desc,
      final Consumer1<Throwable> consumer) {
   ...
   */
  @Override
  public default Tuple13Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> withTimeout(final long time,
      final TimeUnit unit) {
   ...
   */
  default Tuple13Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> withSideEffect(
      Function13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, Task<?>> func) {
   ...
   * completion of this task
   */
  default Tuple13Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> withSideEffect(final String desc,
      Function13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, Task<?>> func) {
  ...
  public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> Tuple13Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> cast(
      final Task<Tuple13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>> task) {
