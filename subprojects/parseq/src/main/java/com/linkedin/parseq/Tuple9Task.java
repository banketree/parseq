...
public interface Tuple9Task<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends Task<Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> {
   ...
   */
  default Tuple9Task<T1, T2, T3, T4, T5, T6, T7, T8, T9> andThen(
      final Consumer9<T1, T2, T3, T4, T5, T6, T7, T8, T9> consumer) {
   ...
   */
  default Tuple9Task<T1, T2, T3, T4, T5, T6, T7, T8, T9> andThen(final String desc,
      final Consumer9<T1, T2, T3, T4, T5, T6, T7, T8, T9> consumer) {
   ...
   */
  @Override
  default Tuple9Task<T1, T2, T3, T4, T5, T6, T7, T8, T9> recover(
      final Function1<Throwable, Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> f) {
   ...
   */
  @Override
  default Tuple9Task<T1, T2, T3, T4, T5, T6, T7, T8, T9> recover(final String desc,
      final Function1<Throwable, Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> f) {
   ...
   */
  @Override
  default Tuple9Task<T1, T2, T3, T4, T5, T6, T7, T8, T9> recoverWith(
      final Function1<Throwable, Task<Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>>> f) {
   ...
   */
  @Override
  default Tuple9Task<T1, T2, T3, T4, T5, T6, T7, T8, T9> recoverWith(final String desc,
      final Function1<Throwable, Task<Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>>> f) {
   ...
   */
  @Override
  public default Tuple9Task<T1, T2, T3, T4, T5, T6, T7, T8, T9> onFailure(final String desc,
   ...
   */
  default Tuple9Task<T1, T2, T3, T4, T5, T6, T7, T8, T9> withSideEffect(
      Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, Task<?>> func) {
   ...
   * completion of this task
   */
  default Tuple9Task<T1, T2, T3, T4, T5, T6, T7, T8, T9> withSideEffect(final String desc,
      Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, Task<?>> func) {
  ...
  public static <T1, T2, T3, T4, T5, T6, T7, T8, T9> Tuple9Task<T1, T2, T3, T4, T5, T6, T7, T8, T9> cast(
      final Task<Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> task) {
